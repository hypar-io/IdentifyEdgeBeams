...
namespace IdentifyEdgeBeams
{
    public class Function
    {
        ...
        private IModelStore<IdentifyEdgeBeamsInputs> store;

        public async Task<IdentifyEdgeBeamsOutputs> Handler(IdentifyEdgeBeamsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<IdentifyEdgeBeamsInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<IdentifyEdgeBeamsInputs,IdentifyEdgeBeamsOutputs>(store, IdentifyEdgeBeams.Execute);
